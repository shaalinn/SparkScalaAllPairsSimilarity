...
#define VER_COMMENT         "Added TAPNN methods"
...
//#define TL1    // test candidate vector length in CV for Tanimoto with dotp upper bound based on PS
//#define TL2    // test candidate vector length in CV for Tanimoto with dotp upper bound based on prefix l2-norm at first common feature
//#define TRS    // Tanimoto based remaining score test in CG

//#define MKPL   // prune based on vector lengths in MKJoin
...
#define TANEPS               4e-5           /* epsilon for tanimoto */
...
#define MODE_MMJOIN             2   /* MMJoin algo */
#define MODE_MKJOIN             3   /* MK-Join algo */
#define MODE_MKJOIN2            4   /* MK-Join algo with tighter bounds from ACIIDS 2014 paper */
#define MODE_AP                 5   /* AllPairs */
#define MODE_AP2                6   /* AllPairs new ordering */
#define MODE_L2AP               7   /* L2-norm AllPairs */
#define MODE_L2AP_T2            70  /* Test version of Tanimoto L2-norm AllPairs */
#define MODE_L2APBLSH           8   /* L2-norm AllPairs + BayesLSH-Lite pruning */
#define MODE_L2AP_CT            9   /* Tanimoto L2AP with Cosine thresholding */
#define MODE_L2AP_MT            10   /* Tanimoto L2AP with MMJoin thresholding */
