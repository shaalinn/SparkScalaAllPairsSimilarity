...
int main(int argc, char *argv[]) {
	params_t *params;
	char fname[256],command[256],textfile[256];
	time_t seconds;
	seconds=time(NULL);
	struct timeval now;
	...
	sprintf(fname,"/Users/samin/Downloads/l2ap/build/test%ld-%d.clu",now.tv_usec,r);
