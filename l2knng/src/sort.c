...
/*************************************************************************/
void da_ppkvsorti(const size_t n, da_ppkv_t* const base)
{
...
/*************************************************************************/
void da_ppkvsortd(const size_t n, da_ppkv_t* const base)
{
...
/*************************************************************************/
void da_pvkvsorti(const size_t n, da_pvkv_t* const base)
{
...
/*************************************************************************/
void da_pvkvsortd(const size_t n, da_pvkv_t* const base)
{
...
/*************************************************************************/
void da_pckvsorti(const size_t n, da_pckv_t* const base)
{
...
/*************************************************************************/
void da_pckvsortd(const size_t n, da_pckv_t* const base)
{
...
/*************************************************************************/
void da_pi32kvsorti(const size_t n, da_pi32kv_t* const base)
{
...
/*************************************************************************/
void da_pi32kvsortd(const size_t n, da_pi32kv_t* const base)
{
...
/*************************************************************************/
void da_pi64kvsorti(const size_t n, da_pi64kv_t* const base)
{
...
/*************************************************************************/
void da_pi64kvsortd(const size_t n, da_pi64kv_t* const base)
{
...
/*************************************************************************/
void da_pzkvsorti(const size_t n, da_pzkv_t* const base)
{
...
/*************************************************************************/
void da_pzkvsortd(const size_t n, da_pzkv_t* const base)
{
...
/*************************************************************************/
void da_pfkvsorti(const size_t n, da_pfkv_t* const base)
{
...
/*************************************************************************/
void da_pfkvsortd(const size_t n, da_pfkv_t* const base)
{
...
/*************************************************************************/
void da_pdkvsorti(const size_t n, da_pdkv_t* const base)
{
...
/*************************************************************************/
void da_pdkvsortd(const size_t n, da_pdkv_t* const base)
{
...
/*************************************************************************/
void da_pskvsorti(const size_t n, da_pskv_t* const base)
{
...
/*************************************************************************/
void da_pskvsortd(const size_t n, da_pskv_t* const base)
{
...
/*************************************************************************/
void da_ipkvsorti(const size_t n, da_ipkv_t* const base)
{
...
/*************************************************************************/
void da_ipkvsortd(const size_t n, da_ipkv_t* const base)
{
...
/*************************************************************************/
void da_iakvsorti(const size_t n, da_iakv_t* const base)
{
...
/*************************************************************************/
void da_iakvsortd(const size_t n, da_iakv_t* const base)
{
...
/*************************************************************************/
void da_ickvsorti(const size_t n, da_ickv_t* const base)
{
...
/*************************************************************************/
void da_ickvsortd(const size_t n, da_ickv_t* const base)
{
...
/*************************************************************************/
void da_ii32kvsorti(const size_t n, da_ii32kv_t* const base)
{
...
/*************************************************************************/
void da_ii32kvsortd(const size_t n, da_ii32kv_t* const base)
{
...
/*************************************************************************/
void da_ii64kvsorti(const size_t n, da_ii64kv_t* const base)
{
...
/*************************************************************************/
void da_ii64kvsortd(const size_t n, da_ii64kv_t* const base)
{
...
/*************************************************************************/
void da_izkvsorti(const size_t n, da_izkv_t* const base)
{
...
/*************************************************************************/
void da_izkvsortd(const size_t n, da_izkv_t* const base)
{
...
/*************************************************************************/
void da_ifkvsorti(const size_t n, da_ifkv_t* const base)
{
...
/*************************************************************************/
void da_ifkvsortd(const size_t n, da_ifkv_t* const base)
{
...
/*************************************************************************/
void da_idkvsorti(const size_t n, da_idkv_t* const base)
{
...
/*************************************************************************/
void da_idkvsortd(const size_t n, da_idkv_t* const base)
{
...
/*************************************************************************/
void da_iskvsorti(const size_t n, da_iskv_t* const base)
{
...
/*************************************************************************/
void da_iskvsortd(const size_t n, da_iskv_t* const base)
{
...
/*************************************************************************/
void da_upkvsorti(const size_t n, da_upkv_t* const base)
{
...
/*************************************************************************/
void da_upkvsortd(const size_t n, da_upkv_t* const base)
{
...
/*! Sorts an array of da_pikv_t in increasing order */
/*************************************************************************/
void da_uikvsorti(const size_t n, da_uikv_t* const base)
{
...
/*************************************************************************/
void da_uikvsortd(const size_t n, da_uikv_t* const base)
{
...
/*************************************************************************/
void da_uvkvsorti(const size_t n, da_uvkv_t* const base)
{
...
/*************************************************************************/
void da_uvkvsortd(const size_t n, da_uvkv_t* const base)
{
...
/*************************************************************************/
void da_uakvsorti(const size_t n, da_uakv_t* const base)
{
...
/*************************************************************************/
void da_uakvsortd(const size_t n, da_uakv_t* const base)
{
...
/*************************************************************************/
void da_uckvsorti(const size_t n, da_uckv_t* const base)
{
...
/*************************************************************************/
void da_uckvsortd(const size_t n, da_uckv_t* const base)
{
...
/*************************************************************************/
void da_ui32kvsorti(const size_t n, da_ui32kv_t* const base)
{
...
/*************************************************************************/
void da_ui32kvsortd(const size_t n, da_ui32kv_t* const base)
{
...
/*************************************************************************/
void da_ui64kvsorti(const size_t n, da_ui64kv_t* const base)
{
...
/*************************************************************************/
void da_ui64kvsortd(const size_t n, da_ui64kv_t* const base)
{
...
/*************************************************************************/
void da_uzkvsorti(const size_t n, da_uzkv_t* const base)
{
...
/*************************************************************************/
void da_uzkvsortd(const size_t n, da_uzkv_t* const base)
{
...
/*************************************************************************/
void da_ufkvsorti(const size_t n, da_ufkv_t* const base)
{
...
/*************************************************************************/
void da_ufkvsortd(const size_t n, da_ufkv_t* const base)
{
...
/*************************************************************************/
void da_udkvsorti(const size_t n, da_udkv_t* const base)
{
...
/*************************************************************************/
void da_udkvsortd(const size_t n, da_udkv_t* const base)
{
...
/*************************************************************************/
void da_uskvsorti(const size_t n, da_uskv_t* const base)
{
...
/*************************************************************************/
void da_uskvsortd(const size_t n, da_uskv_t* const base)
{
...
/*************************************************************************/
void da_ilsorti(const size_t n, da_il_t** const base)
{
...
/*************************************************************************/
void da_ilsortd(const size_t n, da_il_t** const base)
{
...
/*************************************************************************/
void da_bilsorti(const size_t n, da_bil_t** const base)
{
...
/*************************************************************************/
void da_bilsortd(const size_t n, da_bil_t** const base)
{
...
/*************************************************************************/
void da_uukvsorti(const size_t n, da_uukv_t* const base)
{
...
/*************************************************************************/
void da_uukvsortd(const size_t n, da_uukv_t* const base)
{
...
/*************************************************************************/
void da_iiakvsorti(const size_t n, da_iiakv_t* const base)
{
...
/*************************************************************************/
void da_iiakvsortd(const size_t n, da_iiakv_t* const base)
{
...
/*************************************************************************/
void da_iiakeysorti(const size_t n, da_iiakv_t* const base)
{
...
/*************************************************************************/
void da_iiakeysortd(const size_t n, da_iiakv_t* const base)
{
