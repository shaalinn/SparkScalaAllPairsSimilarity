 ...
 **************************************************************************/
int
da_fexists (const char *const fname)
{
  struct stat status;
 ...
 **************************************************************************/
int
da_dexists (const char *const dirname)
{
  struct stat status;
...
/**************************************************************************/
ssize_t
da_getfsize (const char *const filename)
{
  struct stat status;
 ...
 **************************************************************************/
char *
da_getbasename (const char *const path)
{
 ...
 **************************************************************************/
char *
da_getextname (const char *const path)
{
  char *startptr;
 ...
 **************************************************************************/
char *
da_getfilename (const char *const path)
{
  char *startptr;
 ...
 **************************************************************************/
char *
da_getpathname (const char *const path)
{
  char *endptr, *tmp;
 ...
 **************************************************************************/
int
da_mkpath (const char *const path)
{
  char tmp[2048];
 ...
 **************************************************************************/
int
da_rmpath (const char *const path)
{
  char tmp[2048];
...
/*************************************************************************/
void
da_getfilestats (const char *const fname, size_t * r_nlines,
		 size_t * r_ntokens, size_t * r_max_nlntokens,
		 size_t * r_nbytes)
{
  size_t nlines = 0, ntokens = 0, max_nlntokens = 0, nbytes = 0, oldntokens =
    0, nread;
