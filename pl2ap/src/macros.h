...
#ifndef _COSGRAPH_MACROS_H_
#define _COSGRAPH_MACROS_H_
...
#define DA_ASSERT_CLOSE(a,b,fmt) \
    DA_ASSERT(da_abs(a - b) < 1e-4,"("#a" = "fmt") !close ("#b" = "fmt")",a,b)
#else
#define wprintf(fmt, ...)
#define dprintf(fmt, ...)
#define DA_ASSERT(cnd,fmt, ...)
#define DA_ASSERT_EQUALS(a,b,fmt)
#define DA_ASSERT_CLOSE(a,b,fmt)
#endif
