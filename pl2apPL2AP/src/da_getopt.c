...
static int da_getopt_internal (int argc, char **argv, char *optstring,
			       struct da_option *longopts, int *longind,
			       int long_only);
...
/*************************************************************************/
static char *
da_getopt_initialize (int argc, char **argv, char *optstring)
{
...
/*************************************************************************/
static int
da_getopt_internal (int argc, char **argv, char *optstring,
...
#define NONOPTION_P (argv[da_optind][0] != '-' || argv[da_optind][1] == '\0')
  ...
  if (nextchar == NULL || *nextchar == '\0')
      ...
      if (NONOPTION_P)
	{
      ...
      nextchar =
	(argv[da_optind] + 1 +
	 (longopts != NULL && argv[da_optind][1] == '-'));
    }
  ...
  if (longopts != NULL
	  ...
	  || (long_only
	      && (argv[da_optind][2]
		  || !strchr (optstring, argv[da_optind][1])))))
    {
      char *nameend;
      struct da_option *p;
  ...
  /* Look at and handle the next short option-character.  */
  {
	...
	for (nextchar = nameend = da_optarg; *nameend && *nameend != '=';
	     nameend++)
	  /* Do nothing.  */ ;
...
/*************************************************************************/
int
da_getopt (int argc, char **argv, char *options)
{
...
/*************************************************************************/
int
da_getopt_long (int argc, char **argv, char *options,
...
/*************************************************************************/
int
da_getopt_long_only (int argc, char **argv, char *options,
		     struct da_option *long_options, int *opt_index)
{
