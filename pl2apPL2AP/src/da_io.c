 ...
 **************************************************************************/
FILE *
da_fopen (const char *const fname, const char *const mode,
...
/*************************************************************************/
ssize_t
da_read (const int fd, void *vbuf, const size_t count)
{
  char *buf = (char *) vbuf;
...
/*************************************************************************/
ssize_t
da_getline (char **lineptr, size_t * n, FILE * stream)
{
#ifdef HAVE_GETLINE
  ...
  while ((ch = getc (stream)) != EOF)
      ...
      if (i + 1 == *n)
	{
	  *n = 2 * (*n);
	  *lineptr =
	    da_realloc (*lineptr, (*n) * sizeof (char),
			"da_getline: lineptr");
	}
...
/*************************************************************************/
char **
da_readfile (const char *const fname, size_t * r_nlines)
{
  ...
  if (nlines > 0)
    {
      lines =
	(char **) da_malloc (nlines * sizeof (char *), "da_readfile: lines");
...
/*************************************************************************/
int32_t *
da_i32readfile (const char *const fname, size_t * r_nlines)
{
  size_t lnlen = 0, nlines = 0;
  char *line = NULL;
  int32_t *array = NULL;
...
/*************************************************************************/
int64_t *
da_i64readfile (const char *const fname, size_t * r_nlines)
{
  size_t lnlen = 0, nlines = 0;
  char *line = NULL;
  int64_t *array = NULL;
...
/*************************************************************************/
int32_t *
da_i32readfilebin (const char *const fname, size_t * r_nelmnts)
{
  size_t nelmnts;
  ssize_t fsize;
  int32_t *array = NULL;
...
/*************************************************************************/
size_t
da_i32writefilebin (const char *const fname, const size_t n,
...
/*************************************************************************/
int64_t *
da_i64readfilebin (const char *const fname, size_t * r_nelmnts)
{
  size_t nelmnts;
  ssize_t fsize;
  int64_t *array = NULL;
...
/*************************************************************************/
size_t
da_i64writefilebin (const char *const fname, const size_t n,
...
/*************************************************************************/
float *
da_freadfilebin (const char *const fname, size_t * r_nelmnts)
{
  size_t nelmnts;
  ssize_t fsize;
  float *array = NULL;
...
/*************************************************************************/
size_t
da_fwritefilebin (const char *const fname, const size_t n,
		  const float *const a)
{
  size_t fsize;
  FILE *fp;
...
/*************************************************************************/
double *
da_dreadfilebin (const char *const fname, size_t * r_nelmnts)
{
  size_t nelmnts;
  ssize_t fsize;
  double *array = NULL;
...
/*************************************************************************/
size_t
da_dwritefilebin (const char *const fname, const size_t n,
